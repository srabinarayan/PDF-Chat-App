...
from pdfchatapp_ool import PdfChatApp, clear_folder
...
with input_container:
    ...
    if submit_button and user_message:
        ...
        #         generated_response= pdfchatapp.get_llm_response(chain = retrieval_chain,question = user_message)
        #         # chat_placeholder.text_area("Chat", value=user_message, height=350)
        #         print(user_message,generated_response)
        #         message(user_message, is_user=True)
        #         message(generated_response)
            # get_llm_response(chain, question)
        # st.write("Message Sent")

    # Row 2: Placeholder for chat interface

    # chat_placeholder = st.empty()  # Create an empty placeholder for the chat interface
    # chat_placeholder.text_area("Chat will appear here...", height=350)
